...
*Shared module, dot-sourced by the engine and the health check. Owns the quiesce lease (fails OPEN) and the health verdict (fails CLOSED). The opposing postures are deliberate.*
